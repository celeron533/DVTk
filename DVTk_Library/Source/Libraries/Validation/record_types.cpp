...
//<<===========================================================================
{
    ...
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_PALETTE,          "PALETTE",           "PRIVATE",                                                                                                                                                                                     TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_IMPLANT,          "IMPLANT",           "PRIVATE",                                                                                                                                                                                     TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_IMPLANT_ASSY,     "IMPLANT ASSY",      "PRIVATE",                                                                                                                                                                                     TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_IMPLANT_GROUP,    "IMPLANT GROUP",     "PRIVATE",                                                                                                                                                                                     TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_INVENTORY,        "INVENTORY",         "PRIVATE",                                                                                                                                                                                     TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_PLAN,             "PLAN",              "PRIVATE",                                                                                                                                                                                     TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_MEASUREMENT,      "MEASUREMENT",       "PRIVATE",                                                                                                                                                                                     TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_SURFACE,          "SURFACE",           "SURFACE SCAN\nPRIVATE",                                                                                                                                                                       TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_SURFACE_SCAN,     "SURFACE SCAN",      "PRIVATE",                                                                                                                                                                                     TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_TRACT,            "TRACT",             "PRIVATE",                                                                                                                                                                                     TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_ASSESSMENT,       "ASSESSMENT",        "PRIVATE",                                                                                                                                                                                     TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_RADIOTHERAPY,     "RADIOTHERAPY",      "PRIVATE",                                                                                                                                                                                     TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_ANNOTATION,       "ANNOTATION",        "PRIVATE",                                                                                                                                                                                     TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
    recordTypesM.push_back(CreateRecordType(DICOMDIR_RECORD_TYPE_WF_PRESENTATION,  "WF PRESENTATION",   "PRIVATE",                                                                                                                                                                                     TAG_UNDEFINED,                           TAG_UNDEFINED,                           false));
